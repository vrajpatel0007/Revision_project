...
const createOrder = async (req, res) => {
    try {
        ...
        if (Order) {
          const email = send_mail(reqBody.c_email,"Order","you are Order successfully ")
        }
...
const deleteOrder = async (req, res) => {
    try {
        ...
        console.log("🚀 ~ deleteOrder ~ OrderExists:", OrderExists)
        if (!OrderExists) {
            throw new Error("Order not found!");
        }

        const deleteOrder = await OrderService.deleteOrder(OrderId);
        console.log("🚀 ~ deleteOrder ~ OrderExists.c_email:", OrderExists.c_email)
        if (!deleteOrder) {
          const email = send_mail(OrderExists.c_email,"delete Order","your  Order successfully delete")
        }
...
const updateDetails = async (req, res) => {
    ...
    try {
        ...
        if (updateDetails) {
          const email = send_mail(reqBody.c_email,"update Order","your Order successfully update")
        }
